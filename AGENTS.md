...
| `.cursor/skills/update-docs/SKILL.md` | Sync compose/env embeds + README demos via skill `update_doc.sh` (root `./update_doc.sh` wraps it; not docs/demo.md scenarios). |
