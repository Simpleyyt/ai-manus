export default {
  ...
  'No files in library': '资料库中暂无文件',
  'Library coming soon': '资料库即将推出',
  ...
  'Collaborate': '协作',
  'Collaboration coming soon': '协作功能即将推出',
  'Invite': '邀请',
  'Email address': '邮箱地址',
  ...
  'Invite others to this task. Collaborators can view and prompt together.': '邀请他人加入此任务。协作者可一起查看并向 Manus 发送指令。',
  'Collaboration invites are stored locally until the backend is available.': '协作邀请暂存于本地，待后端接口就绪后同步。',
  'Already invited': '已邀请过该邮箱',
  'Invitation added': '已添加邀请',
  'Agent mode': 'Agent 模式',
  'Chat mode': 'Chat 模式',
  'Autonomous planning and tool use': '自主规划并使用工具',
  'Fast answers and discussion': '快速问答与讨论',
