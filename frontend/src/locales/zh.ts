export default {
  ...
  'Assign a task or ask anything': '安排一个任务，或问点什么',
  ...
  'Research': '深入研究',
  'Write report': '撰写报告',
  'Create spreadsheet': '创建表格',
  'More': '更多',
  'Create slides prompt': '帮我制作一份幻灯片，主题是',
  'Build website prompt': '帮我搭建一个网站，用于',
  'Design prompt': '帮我设计一个',
  'Create games prompt': '帮我开发一个网页小游戏，主题是',
  'Analyze data prompt': '帮我分析这份数据并给出关键洞察：',
  'Research prompt': '帮我深入研究一下',
  'Write report prompt': '帮我撰写一份详细报告，主题是',
  'Create spreadsheet prompt': '帮我创建一个表格，用于记录',
  // Shell tools
