export default {
  ...
  'No connectors yet': '暂无连接器',
  'Connected': '已连接',
  'Custom MCP': '自定义 MCP',
  'Connect': '连接',
  'Official connector': '官方连接器',
  'Connect {name}': '连接 {name}',
  'Test connection': '测试连接',
  'Testing...': '测试中...',
  'Connection successful ({count} tools)': '连接成功（{count} 个工具）',
  'Connection failed': '连接失败',
  'Connector connected': '连接器已连接',
  'Failed to connect connector': '连接连接器失败',
  'Custom MCP added': '自定义 MCP 已添加',
  'Failed to add custom MCP': '添加自定义 MCP 失败',
  'Connect Manus to your internal tools and proprietary systems': '将 Manus 连接到内部工具与专有系统',
  'Server name': '服务器名称',
  'Internal CRM': '内部 CRM',
  'Transport type': '传输类型',
  'HTTP': 'HTTP',
