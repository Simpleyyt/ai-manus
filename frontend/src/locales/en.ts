export default {
  ...
  'Invite others to this task. Collaborators can view and prompt together.': 'Invite others to this task. Collaborators can view and prompt together.',
  'Collaboration invites are stored locally until the backend is available.': 'Collaboration invites are stored locally until the backend is available.',
  'Already invited': 'Already invited',
  'Invitation added': 'Invitation added',
  'Agent mode': 'Agent mode',
  'Chat mode': 'Chat mode',
  'Autonomous planning and tool use': 'Autonomous planning and tool use',
  'Fast answers and discussion': 'Fast answers and discussion',
