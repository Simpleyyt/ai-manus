...
class AgentService:
    ...
    async def create_task(self, session_id: str, task_id: str | None = None) -> Task:
        """Create an AgentTask for a session (used by Celery workers)."""
        return await self._agent_domain_service.create_task(session_id, task_id)
