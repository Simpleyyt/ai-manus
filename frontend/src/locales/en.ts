export default {
  ...
  'Connect': 'Connect',
  'No custom API added yet.': 'No custom API added yet.',
  'No apps available.': 'No apps available.',
  'Publish your custom MCP and API connectors to share them with your projects.': 'Publish your custom MCP and API connectors to share them with your projects.',
  'Import MCP by JSON': 'Import MCP by JSON',
  'Import by JSON': 'Import by JSON',
  'Please paste your configuration JSON': 'Please paste your configuration JSON',
  'Add MCP by URL': 'Add MCP by URL',
  'Beta': 'Beta',
  'Add connectors': 'Add connectors',
  'Connect {product} with your everyday apps, APIs and MCPs': 'Connect {product} with your everyday apps, APIs and MCPs',
  'No custom MCP added yet.': 'No custom MCP added yet.',
  'No matching connectors.': 'No matching connectors.',
  'Server Name': 'Server Name',
  'Transport Type': 'Transport Type',
  'Note': 'Note',
  ' (optional)': ' (optional)',
  'Provide MCP docs or instructions to tell {product} how and when to use this MCP': 'Provide MCP docs or instructions to tell {product} how and when to use this MCP',
  ...
  'Edit MCP': 'Edit MCP',
  'e.g., My Custom Server': 'e.g., My Custom Server',
  'Edit configuration': 'Edit configuration',
  'Actions': 'Actions',
  'Delete MCP Connector': 'Delete MCP Connector',
  'Are you sure you want to delete this connector? If this connector is already published, deleting it will also unpublish it.': 'Are you sure you want to delete this connector? If this connector is already published, deleting it will also unpublish it.',
  'Successfully created connector': 'Successfully created connector',
  'Successfully updated connector': 'Successfully updated connector',
  ...
  'OAuth marketplace apps are not wired yet.': 'OAuth marketplace apps are not wired yet.',
  'Custom API marketplace install is not wired yet.': 'Custom API marketplace install is not wired yet.',
  'This app requires a sign-in we do not support yet.': 'This app requires a sign-in we do not support yet.',
  'This marketplace MCP has no public server URL, so it cannot be installed here.': 'This marketplace MCP has no public server URL, so it cannot be installed here.',
  'Enter the required API key to connect {name}': 'Enter the required API key to connect {name}',
  'API Key': 'API Key',
